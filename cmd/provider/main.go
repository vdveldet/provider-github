...
import (
	...
	"github.com/vdveldet/provider-github/apis"
	"github.com/vdveldet/provider-github/apis/v1alpha1"
	"github.com/vdveldet/provider-github/config"
	"github.com/vdveldet/provider-github/internal/clients"
	"github.com/vdveldet/provider-github/internal/controller"
	"github.com/vdveldet/provider-github/internal/features"
)
...
func main() {
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Github controllers")
